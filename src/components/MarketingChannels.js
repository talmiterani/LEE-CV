        ...
        <div>
            ...
            <div className="container">
                <div className="col justify-content-start align-items-start pl-0 pr-0">
                    ...
                    <div className="User-Experience-Interface row">
                        <span className="col col-lg-5">In order to attract new B2B customers, we need to create landing pages showcasing our products.</span>
                        <span className="col">My early research focused on exploring different related solutions that are already out there, and how do these products serve their users. In later research I examined far and wide, even in seemingly unrelated fields, to find the best solutions for the product.</span>
                    </div>
                    <div className="role row" style={{marginTop:'150px'}}>
                        <span className="col">Design</span>
                    </div>
                    <h1 className="project-headline" style={{marginTop:'10px'}}>We engage with consumers directly through their preferred communication channels, such as push notifications, SMS, and email.</h1>
